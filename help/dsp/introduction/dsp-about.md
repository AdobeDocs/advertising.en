...
Adobe Advertising is the only independent ad platform that unifies and automates all media, data, audiences, and creative at scale. Deliver connected experiences across all advertising channels: paid search, display, video, connected TV (CTV), audio, and native.
...
* [**Premiere connected TV experience with [!DNL Roku]**](/help/dsp/inventory/roku-inventory.md): [!DNL Roku] and DSP have a unique partnership that empowers you to activate your first-party and third-party data across [!DNL Roku] inventory. This partnership allows you to efficiently reach audiences across the big screen, at scale. By leveraging the only platform with the ability to sync with [!DNL Roku] IDs, marketers can take advantage of deterministic 1:1 targeting with precision and accuracy. Marketers can also access [!DNL Roku] inventory and unique measurement insights.

* [**AI-assisted features**](/help/dsp/introduction/features/ai-agents.md): DSP has AI-assisted agents to help you create reusable audiences and to find product usage information.

>[!MORELIKETHIS]
>
>* [Video: Introduction to Advertising DSP](https://experienceleague.adobe.com/en/docs/advertising-learn/tutorials/dsp/intro)
>* [Video: DSP account structure and user interface](https://experienceleague.adobe.com/en/docs/advertising-learn/tutorials/dsp/ui)
