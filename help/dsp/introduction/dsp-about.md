...
* [**Optimization**](features/optimization.md): [!DNL Campaign Home] gives you the advanced tools, sorting, and insights to manage and optimize your campaigns faster than ever before. Additionally, forecasting and spend recommendations predict the strategies that are expected to perform well, not necessarily what is performing best right now, so you can optimize with data.  
...
* **[Integrations with Adobe Analytics, Adobe Customer Journey Analytics, Adobe Audience Manager, Adobe Target, and Adobe Experience Platform](/help/integrations/home.md)**: Integrations with your existing Adobe products allow you to maximize your first-party data and put advertising on the same level as the rest of the business insights.
...
* [**AI-assisted features**](/help/dsp/introduction/features/ai-agents.md): DSP provides AI-assisted agents to help you create reusable audiences and find product usage instructions and best practices.
