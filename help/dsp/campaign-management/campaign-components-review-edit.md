...
To update multiple settings at once, upload a valid bulksheet file with the changes. To create the bulksheet, edit a downloaded bulksheet with the existing settings. Editable fields include most settings that are normally editable. Fields for settings that aren't used contain blank values.
...
1. Do either of the following:
   ...
   * Next to the campaign, click **[!UICONTROL ...]** > **[!UICONTROL Upload Bulksheet]**.
