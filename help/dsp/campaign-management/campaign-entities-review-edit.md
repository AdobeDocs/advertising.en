---
title: Review and Edit Campaign Entity Settings Using Spreadsheets
description: Learn how to review and edit key package, placement, and ad settings using spreadsheets.
feature: DSP Placements
exl-id: 2de4407d-eb3b-44ff-893c-9fdf6921d4b3
---
# Review and Edit Campaign Entity Settings Using Spreadsheets

<!-- EDIT ALL BELOW -->

You can download the settings for one or more packages, placements, and ads, or for all placements in a campaign, in XLSX ([!DNL Microsoft Excel] spreadsheet) format for review. Use this feature to quickly review such details as:
...
You can then download a blank template for all entity types, enter or paste data from the downloaded information and make changes to select fields, and then upload the information back to DSP all at once. 
