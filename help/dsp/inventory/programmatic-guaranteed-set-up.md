...
1. After you save the deal, select the ads (or 1x1 tracking pixels for publisher-managed ads) that will be used for the deal and create a PG default placement, as prompted.
