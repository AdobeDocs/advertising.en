...
**[!UICONTROL Genre]:** (<!-- Beta feature ?? -->Ad groups in [!UICONTROL Audience CTV Video] campaigns; available in US, CA, BR, MX, UK, DE, ES, FR, IT, AU, MY, and TH<!-- should that go in the campaign sub-type description instead, or is this applicable for this feature only? -->) The target genres, which determine the shows and channels on which your ads appear:

* *[!UICONTROL All genres]:* (The default) Targets all genres.

* *[!UICONTROL Let me choose specific genres]:* Targets selected genres. Select from the list of all available genres.
