...
| [!UICONTROL Creative Status] | The status of the ad: Active, Paused, or Deleted. |
...
| [!UICONTROL Keyword] | The keyword.<br><br><b>Note:</i> If the report includes data from ad groups in content-enabled search campaigns, then this column includes the applicable ad group names such "(adgroup content) Your Ad Group Name." For a site-targeted placement in a search campaign, this column doesn't have a value. |
