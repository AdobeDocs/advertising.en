...
All rules created in the [!DNL Google Ads] interface are synced within 24 hours and are available in the Optimization > Conversion Value Rules view. Some accounts can manage their conversion value rules:
