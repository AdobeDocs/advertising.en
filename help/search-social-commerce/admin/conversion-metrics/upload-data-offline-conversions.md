...
| Conversion Value | (Required) The numeric conversion value. |
| Conversion Currency | The currency code for the conversion event. |
| Microsoft Click ID | (Required for regular offline conversions) The associated unique Microsoft click identifier (MSCLKID). This field may be empty for enhanced offline conversions. |
