...
* Rename a campaign from within the row.

* Delete or change the status of a campaign from within the row.
...
>* [Manage data view reports from the [!UICONTROL Campaigns] view](campaign-view-report.md)
