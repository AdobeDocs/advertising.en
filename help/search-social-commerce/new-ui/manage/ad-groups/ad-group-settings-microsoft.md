...
## [!UICONTROL Networks] tab

**[!UICONTROL Networks]:** (Search ads) How and where to place ads within the ad group:

* *[!UICONTROL Only Bing and Yahoo websites]* (the default): To place bids for ads on the search network.

* *[!UICONTROL Only Bing and Yahoo syndicated search partners]:* To place bids for ads on syndicated partner sites.
...
**[!UICONTROL Gender]:** (Optional) Specific genders to include or exclude as targets: *[!UICONTROL Male]*, *[!UICONTROL Female]*, and *[!UICONTROL Unknown]*. By default, all genders are targeted. Exclusions always override inclusions.
...
**[!UICONTROL Age]:** (Optional) Specific age categories to include or exclude as targets: *[!UICONTROL 18-24]*, *[!UICONTROL 25-34]*, *[!UICONTROL 35-49]*, *[!UICONTROL 50-64]*, *[!UICONTROL 65+]*, and *[!UICONTROL Unknown]*. By default, all ages are targeted. Exclusions always override inclusions.
...
**[!UICONTROL Company targets]:** (Optional) Specific companies from user [!DNL LinkedIn] profiles to include or exclude as targets. By default, all companies are targeted. To narrow down the targeting, search for and select individual enterprise and mid-level organizations companies. Exclusions always override inclusions.

* To target all values, don't select any values.

* To include a value, click the adjacent circle once so that a blue checkmark (![Include](/help/search-social-commerce/assets/include.png "Include")) appears. You can optionally increase or decrease bids by a specified percentage for each company targeted.

* To exclude a value, click the adjacent circle twice so that a red checkmark (![Exclude](/help/search-social-commerce/assets/exclude.png "Exclude")) appears.

**[!UICONTROL Industry]:** (Optional) Specific industries from user [!DNL LinkedIn] profiles to include or exclude as targets. By default, all industries are targeted. Exclusions always override inclusions.
...
**[!UICONTROL Job Function Targets]:** (Optional) Specific job functions from user [!DNL LinkedIn] profiles to include or exclude as targets. By default, all job functions are targeted. Exclusions always override inclusions.
...
(Optional) The number of times a customer can be served ads from the ad group. Enter a value and select the time unit (*[!UICONTROL Hour]*, *[!UICONTROL Day]*, *[!UICONTROL Week]*)or *[!UICONTROL Month]*).
