...
---
# (New UI) Manage data view reports from the [!UICONTROL Portfolios] view

*Beta feature*

You can generate a report that includes the data rows for one or more portfolios in the [!UICONTROL Portfolios] view, and then download the report as a Microsoft Excel worksheet file (XLXS format). The report includes all visible columns in the view.
...
1. Specify the portfolios whose data you want to download:

   * To download data for specific portfolios, select the check boxes next to the portfolios.
   
   * To download data for all portfolios, you don't need to select any check boxes. All portfolios are included by default.
...
1. In the [!UICONTROL Grid Reports] settings, enter a unique report name, and then click **[!UICONTROL Generate]**.
   ...
   By default, the file is named "portfolio_YYYYMMDD_NNNN," where "NNNN" is the sequential job number (such as "portfolio_20250402_1326).
