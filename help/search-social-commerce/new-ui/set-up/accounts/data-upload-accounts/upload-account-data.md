...
description: Learn how to upload offline account data manually or to an [!DNL Amazon] [!DNL S3] bucket for reporting and simulation support.
---
...
1. Do either of the following:
   ...
   * (From the [!UICONTROL Accounts] view):
     ...
     1. Select the check box next to the account name, and then click **[!UICONTROL Upload]** in the floating toolbar.
...
You can track the progress of the upload job using the [[!UICONTROL Upload Logs] feature](upload-log.md).
