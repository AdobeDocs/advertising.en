...
To generate reports in your designated FTP directory, create a [report template](report-templates-manage.md) with the following naming conventions and schedule.
