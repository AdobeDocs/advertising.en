...
* The event type matches the actual page behavior (for example, [!UICONTROL Library Loaded] vs. [!UICONTROL DOM Ready] vs. [!UICONTROL Window Loaded]).
...
#### Step 3: Validate the outbound XDM payload
