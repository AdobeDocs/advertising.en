...
| ---- | ------- | ----------- | -------------------- |
| 19 July 2023 | Reporting | (DSP users with [!DNL Analytics for Advertising]) View-through conversions for connected TV (CTV) placements are now included in conversion data available within  DSP custom reports. Previously, they were included only within Adobe Analytics. | See "[FAQs About Household Reports](/help/dsp/reports/faq-household-report.md)." |
