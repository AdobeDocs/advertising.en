...
| ---- | ------- | ----------- | -------------------- |
| 13 July 2023 | Reporting | (DSP users with [!DNL Analytics for Advertising]) View-throughs for connected TV (CTV) placements are now available within DSP reports and within Adobe Analytics. | See the section on "Examples of How to Use the Integration" in "[Overview of [!DNL Analytics for Advertising]](/help/integrations/analytics/overview.md#integration-examples)." |
