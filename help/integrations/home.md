...
| ---- | ------- | ----------- | -------------------- |
| 13 July 2023 | Reporting | (DSP users with [!DNL Analytics for Advertising]) View-throughs for connected TV (CTV) placements are now available within Adobe Analytics, as well as within DSP reports. | See the section on "Examples of How to Use the Integration" in "[Overview of [!DNL Analytics for Advertising]](/help/integrations/analytics/overview.md#integration-examples)." |
