...
| ---- | ------- | ----------- | -------------------- |
| 8 August 2023 | [!DNL Analytics for Advertising] | Some [!DNL Analytics] success event metrics, including standard, custom, and reserved conversion metrics and traffic metrics, are automatically available in DSP and Search, Social, & Commerce. Now, you now can also configure your own success metrics based on your existing [!DNL Analytics] [!DNL eVars] and [!DNL props] by funneling [!DNL eVar]- and [!DNL prop]-level data into a custom success event. | See "[Create Conversion Metrics from Adobe Analytics [!DNL eVars] and [!DNL Props]](/help/integrations/analytics/conversion-metrics-from-evars.md)." |
