...
You can create multiple creative libraries for each advertiser. You can later populate each library with [standard creatives](creative-add-standard.md), [dynamic creatives](creative-add-dynamic.md), and [creative bundles](bundle-manage.md).
