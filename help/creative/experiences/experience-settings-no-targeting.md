...
**Radius:** (Experiences with dynamic ads only; optional) A user radius to target. Select a radius from 0 miles to 200 miles.<!-- Does this end up in the ad tag parameters? -->
