...
When you create ads in [!UICONTROL Creative Studio], the AI agent uses brand profile information to ground content generation in your specific brand. Recommendations for headlines, CTAs, background images, and colors reflect your brand's style and tone without requiring you to re-describe your brand in every ad creation session.

## The [!UICONTROL Brands] view

The [!UICONTROL Brands] view lists all brand profiles associated with your [!DNL Creative] account. Each profile card displays the brand name, logo, and the date the profile was last modified.
...
>[!NOTE]
>
>Deleting a brand profile doesn't affect existing [!UICONTROL Creative Studio] sessions that already used the profile.

You can delete a brand profile from the brand list or from the brand detail page.
...
**From the brand detail page:**

1. In the main menu, click **[!UICONTROL Brands]**.

1. Click the brand profile you want to delete.

1. Click **[!UICONTROL Brand actions]** and select **[!UICONTROL Delete]**.

1. In the confirmation message, click **[!UICONTROL Delete]**.

## Brand profile settings {#brand-profile-settings}
...
>[!MORELIKETHIS]
>
>* [About Creative Studio in Advertising Creative](/help/creative/creative-studio/creative-studio-about.md)
